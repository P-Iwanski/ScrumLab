                    ...
                    <c:if test="${recipe.dayName.equals('poniedziałek')}">
                        ...
                        <tr class="d-flex">
                            ...
                            <td class="col-1 center">
                                <a href='<c:url value="/app/plan/details/delete?id=${recipe.recipePlanId}"/>' class="btn btn-danger rounded-0 text-light m-1" onclick="return confirm('Czy na pewno chcesz usunąć przepis z planu?')">Usuń</a>
                            </td>
