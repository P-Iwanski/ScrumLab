                    ...
                    <form method="post">
                        ...
                        <table class="table borderless">
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-7">
                                    <input class="w-100 p-1" name="recipeName" value=${recipe.name}>
                                </td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2">Opis przepisu</th>
                                <td class="col-7"><textarea class="w-100 p-1" name="recipeDescription" rows="5"><c:out
                                        value="${recipe.description}"/></textarea></td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2">Przygotowanie (minuty)</th>
                                <td class="col-3">
                                    <input class="p-1" type="number" name="preparationTime"
                                           value="${recipe.preparationTime}">
                                </td>
                                <input type="hidden" id="thisField" name="created" value="${recipe.created}">
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="row d-flex">
                            <div class="col-5 p-4">
                                <textarea class="w-100 p-1" name="preparation" rows="10"><c:out
